...
import {
  loadProjects, deleteProject, formatDate,
  type Project,
...
function ProjectCard({ project, onSelect, onEdit, onDelete, onAddUser }: ProjectCardProps) {
  ...
  return (
    ...
    >
      ...
      <Stack direction="row" sx={{ justifyContent: 'space-between', alignItems: 'flex-start', mb: 1.5 }}>
        <Box>
          <Typography variant="body1" sx={{ fontWeight: 700, mb: 0.25 }}>{project.projectName}</Typography>
...
function EmptyState({ onCreate }: EmptyStateProps) {
  return (
    <Box sx={{ textAlign: 'center', py: 8, px: 4 }}>
      ...
      <Typography variant="h6" sx={{ fontWeight: 700, mb: 1 }}>No projects yet</Typography>
...
export function ProjectPicker({ onSelect, onCreateNew, onAddUser }: ProjectPickerProps) {
  ...
  return (
    <Box sx={{ maxWidth: 860, mx: 'auto', py: 4, px: { xs: 2, md: 0 } }}>
      {/* Hero */}
      <Stack direction="row" sx={{ justifyContent: 'space-between', alignItems: 'center', mb: 4 }}>
        <Box>
          <Typography variant="h4" sx={{ mb: 0.5 }}>Projects</Typography>
      ...
      {projects.length === 0 ? (
        ...
        <>
          ...
          <Box sx={{
            ...
            >
              <Box sx={{ color: 'text.secondary', display: 'flex' }}><PlusIcon /></Box>
              <Typography variant="body2" color="text.secondary" sx={{ fontWeight: 500 }}>Add Project</Typography>
            </Paper>
          </Box>

          {filtered.length === 0 && search && (
            <Box sx={{ textAlign: 'center', py: 4 }}>
              <Typography variant="body2" color="text.secondary">No projects match &quot;{search}&quot;</Typography>
            </Box>
          )}
        </>
      )}
